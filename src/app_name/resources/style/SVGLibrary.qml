...
QtObject {
    readonly property url back: Qt.resolvedUrl("../assets/icons/navigation/back.svg")
    readonly property url settings: Qt.resolvedUrl("../assets/icons/settings/settings.svg")
